...
// ============================================================
// CLIENT-SIDE COMPUTATION — the formulas live in banister (adjust.ts)
// ============================================================

import type { NormalizedStep } from "@/lib/normalize-steps";
import { DEFAULT_BASE_PACE, readinessFactorCalc, fatigueFactorCalc, computeAdjustedPace, adjustStepTargets } from "banister";
export { DEFAULT_BASE_PACE, readinessFactorCalc, fatigueFactorCalc, computeAdjustedPace, adjustStepTargets };
